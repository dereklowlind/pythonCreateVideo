...
# split sentences so each senetence in a comment appears as it is spoken
# def split_sentence(data):
#     data_output = []
#     data_output["submissionData"] = data["submissionData"]
#     for com in data["commentsData"]:
#         if com["isChecked"]: # is this a selected comment
#             print(0)
...
def process_file(file_name): 
    ...
    #         print(com["body"])
    #         print("---Tokenized")
    #         for sent in sent_tokenize(com["body"]):
    #             print(sent)
    #         print(sent_tokenize(com["body"]))
    #         print()
